...
var new121021801 = require('./routes/new121021801');
var new121021802 = require('./routes/new121021802');
var new121021803 = require('./routes/new121021803');
var new121021804 = require('./routes/new121021804');
var new121021805 = require('./routes/new121021805');
var new121021806 = require('./routes/new121021806');
var new121021807 = require('./routes/new121021807');
var new121021901 = require('./routes/new121021901');
var new121021902 = require('./routes/new121021902');
var new121021903 = require('./routes/new121021903');
var new121022001 = require('./routes/new121022001');
var new121022002 = require('./routes/new121022002');
var new121022003 = require('./routes/new121022003');
var new121022004 = require('./routes/new121022004');
var new121022005 = require('./routes/new121022005');
...
app.use('/new121021801', new121021801);
app.use('/new121021802', new121021802);
app.use('/new121021803', new121021803);
app.use('/new121021804', new121021804);
app.use('/new121021805', new121021805);
app.use('/new121021806', new121021806);
app.use('/new121021807', new121021807);
app.use('/new121021901', new121021901);
app.use('/new121021902', new121021902);
app.use('/new121021903', new121021903);
app.use('/new121022001', new121022001);
app.use('/new121022002', new121022002);
app.use('/new121022003', new121022003);
app.use('/new121022004', new121022004);
app.use('/new121022005', new121022005);
